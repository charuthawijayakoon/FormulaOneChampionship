...
public class FrmAcendingDisplay  extends JFrame       {
    JFrame frame2 ;
    String column[]={"Driver Name","1st Places","2nd Places","3rd Places","NFRF", "Total Point"};
    //NFRF = Number of FormulaOne Races Faced
    public FrmAcendingDisplay(ArrayList<Formula1Driver> driverStatics){

        frame2 = new JFrame();
        Comparator<Formula1Driver> cmp = Collections.reverseOrder(new TotalAsending());
